...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/mail)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/mail
```

A live public deployment of this template is available at [https://mail.templates.workers.dev](https://mail.templates.workers.dev)
